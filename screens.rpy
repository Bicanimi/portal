...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Carregar R.") action QuickLoad()
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Opcões") action ShowMenu("preferences")

        if _in_replay:

            textbutton _("Finalizar repeticão") action EndReplay(confirm=True)
...
screen preferences():
    ...
    use game_menu(_("Opcições"), scroll="viewport"):
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        ...
                        textbutton _("Tela completa") action Preference("display", "fullscreen")
                ...
                vbox:
                    ...
                    textbutton _("Opções anteriores") action Preference("after choices", "toggle")
...
screen history():
    ...
    use game_menu(_("Histórico"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("O histórico esta vazio.")
    ...
    use game_menu(_("Ajuda"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    textbutton _("comando") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança o diálogo e ativa la interface.")

    hbox:
        label _("Espaço")
        text _("Avança o diálogo sem selecionar opcições.")
    ...
    hbox:
        label _("Ctrl")
        text _("Salta o diálogo enquanto pressionado.")

    hbox:
        label _("Tabulador")
        text _("Ativa/desativa o salto de diálogo.")
    ...
    hbox:
        label _("Re. pág.")
        text _("Avança para o diálogo siguiente.")
    ...
    hbox:
        label "V"
        text _("Ativa/desativa a asstencia por {a=https://www.renpy.org/l/voicing}voz-automática{/a}.")


screen mouse_help():

    hbox:
        label _("Clic esquerdo")
    ...
    hbox:
        label _("Clic direito")
        text _("Acessa o menú do jogo.")

    hbox:
        label _("Roda do mouse para cima\Clic ao lado do retorno")
...
screen gamepad_help():
    ...
    hbox:
        label _("Botão derecho\Botão inferior")
        text _("Avança ao diálogo e ativa a interface.")

    hbox:
        label _("Botão esquerdo\Botão sup. frontal esq.")
        text _("Retrocede ao diálogo anterior.")

    hbox:
        label _("Botão sup. frontal dir.")
    ...
    hbox:
        label _("Començar, Guía")
        text _("Acessa ao menu do jogo.")
